# Multisensory Nature (Climate Variant) — PsychoJS (Online)
...
This is a climate-focused variant of the Multisensory Nature task, using the same experimental structure but adapted for climate change research contexts. Like the base version, participants view audiovisual recordings varying in visual nature and sound type while rating their emotional state.

The experiment structure mirrors the main Multisensory Nature task: instructions, a pre-task I-PANAS-SF questionnaire, a trial loop presenting 60-second audiovisual clips, affect ratings after each clip, and a thank-you screen. The same set of video resources (N1, N3, N8, N13, N14, R5, R8, R12, R13, R14, T3, T5, T6, T12, T13) and the condition file (`vids.xlsx`) are used.

This variant was developed as part of the 1 in 5 Climate Change Project, exploring how multisensory nature experiences might be leveraged in climate communication and wellbeing interventions. The key adaptation is the framing and context, potentially with different questionnaires or instruction text emphasizing climate-related themes.

## Key Design Patterns

- **Identical structure to base Multisensory Nature task** with the same video resources, condition file, and trial timing
- **Climate change research context**: adapted for the 1 in 5 Climate Change Project initiative
- **`visual.MovieStim`** for 60-second audiovisual clip presentation with synchronized audio
- **Slider-based affect ratings** after each video clip
- **I-PANAS-SF pre-task questionnaire** for baseline mood assessment
- **Resource preloading**: 17 video files and 1 Excel questionnaire loaded at experiment start
