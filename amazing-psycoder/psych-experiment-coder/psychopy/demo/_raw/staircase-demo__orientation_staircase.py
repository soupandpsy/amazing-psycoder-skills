...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\44797\\OneDrive - Open Science Tools\\Research\\EPIC\\tasks\\staircase\\orientation_staircase.py',
...
grating = visual.ImageStim(
    win=win,
    name='grating', 
    image='Stimuli/grating_cropped.png', mask='gauss',
...
for thisTrial in trials:
    ...
    grating.setOri(this_ori)
    key_resp.keys = []
    key_resp.rt = []
    _key_resp_allKeys = []
    it trialCount ==0:
        shuffle(start_oris)
        this_ori = start_oris[0]
    
    # keep track of which components have finished
    trialComponents = [grating, key_resp]
