...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/Becca/Library/CloudStorage/GoogleDrive-becca@opensciencetools.org/Shared drives/Science/Pavlovia Demos/cyberball/cyberball_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    player1ball_counttxt = visual.TextBox2(
         win, text='', placeholder='Type here...', font='Arial',
         ori=0.0, pos=(-0.5, 0.45), draggable=False,      letterHeight=0.03,
         size=(0.5, 0.05), borderWidth=2.0,
         color='black', colorSpace='rgb',
         opacity=None,
         bold=False, italic=False,
         lineSpacing=1.0, speechPoint=None,
    ...
    player2ball_counttxt = visual.TextBox2(
         win, text='', placeholder='Type here...', font='Arial',
         ori=0.0, pos=(0.5, 0.45), draggable=False,      letterHeight=0.03,
         size=(0.5, 0.05), borderWidth=2.0,
         color='black', colorSpace='rgb',
    ...
    player3ball_counttxt = visual.TextBox2(
         win, text='', placeholder='Type here...', font='Arial',
         ori=0.0, pos=(0, -0.15), draggable=False,      letterHeight=0.03,
         size=(0.5, 0.05), borderWidth=2.0,
         color='black', colorSpace='rgb',
         opacity=None,
         bold=False, italic=False,
    ...
    player1ball_counttxt_2 = visual.TextBox2(
         win, text='', placeholder='Type here...', font='Arial',
         ori=0.0, pos=(-0.5, 0.45), draggable=False,      letterHeight=0.03,
         size=(0.5, 0.05), borderWidth=2.0,
         color='black', colorSpace='rgb',
    ...
    player2ball_counttxt_2 = visual.TextBox2(
         win, text='', placeholder='Type here...', font='Arial',
         ori=0.0, pos=(0.5, 0.45), draggable=False,      letterHeight=0.03,
         size=(0.5, 0.05), borderWidth=2.0,
         color='black', colorSpace='rgb',
    ...
    player3ball_counttxt_2 = visual.TextBox2(
         win, text='', placeholder='Type here...', font='Arial',
         ori=0.0, pos=(0, -0.15), draggable=False,      letterHeight=0.03,
         size=(0.5, 0.05), borderWidth=2.0,
         color='black', colorSpace='rgb',
    ...
    instructtxt_3 = visual.TextBox2(
         win, text='Thank you for participating in this demonstration of the Cyberball task.\n\nFeel free to adapt this demo for your own research!', placeholder='Type here...', font='Arial',
         ori=0.0, pos=(0, 0), draggable=False,      letterHeight=0.03,
         size=(1.5, 1), borderWidth=2.0,
         color='black', colorSpace='rgb',
         opacity=None,
    ...
    start_button_3 = visual.ButtonStim(win, 
        text='EXIT', font='Arvo',
        pos=(0, -0.4),
        letterHeight=0.05,
        size=(0.5, 0.1), 
    ...
    start_button_3.buttonClock = core.Clock()
    ...
    blocks = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('spreadsheets/blocks.xlsx'), 
        seed=None, 
    )
    ...
    for thisBlock in blocks:
        ...
        instructions_2 = data.Routine(
            name='instructions_2',
            components=[instructtxt_2, start_button_2],
        )
        ...
        while continueRoutine:
            ...
            # if instructtxt_2 is starting this frame...
            if instructtxt_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                instructtxt_2.frameNStart = frameN  # exact frame index
                instructtxt_2.tStart = t  # local t and not account for scr refresh
                instructtxt_2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(instructtxt_2, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'instructtxt_2.started')
                # update status
                instructtxt_2.status = STARTED
                instructtxt_2.setAutoDraw(True)
            
            # if instructtxt_2 is active this frame...
            if instructtxt_2.status == STARTED:
                # update params
                pass
        ...
        blocks.addData('start_button_2.numClicks', start_button_2.numClicks)
        if start_button_2.numClicks:
           blocks.addData('start_button_2.timesOn', start_button_2.timesOn)
           blocks.addData('start_button_2.timesOff', start_button_2.timesOff)
        else:
           blocks.addData('start_button_2.timesOn', "")
           blocks.addData('start_button_2.timesOff', "")
        ...
        for thisTrial in trials:
            ...
            trial = data.Routine(
                name='trial',
                components=[player3image, player1image, player2image, mouse, instructtxtbox, player1ball_counttxt, player2ball_counttxt, player3ball_counttxt, ballimage],
            )
            ...
            player1ball_counttxt.reset()
            player1ball_counttxt.setText('Balls received: ' + str(player_1_ball_count))
            player2ball_counttxt.reset()
            player2ball_counttxt.setText('Balls received: ' + str(player_2_ball_count))
            player3ball_counttxt.reset()
            player3ball_counttxt.setText('Balls received: ' + str(player_3_ball_count))
            ...
            while continueRoutine:
                ...
                if mouse.status == NOT_STARTED and ball_to == "choose":
                    # keep track of start time/frame for later
                ...
                # if player1ball_counttxt is starting this frame...
                if player1ball_counttxt.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    player1ball_counttxt.frameNStart = frameN  # exact frame index
                    player1ball_counttxt.tStart = t  # local t and not account for scr refresh
                    player1ball_counttxt.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(player1ball_counttxt, 'tStartRefresh')  # time at next scr refresh
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'player1ball_counttxt.started')
                    # update status
                    player1ball_counttxt.status = STARTED
                    player1ball_counttxt.setAutoDraw(True)
                
                # if player1ball_counttxt is active this frame...
                if player1ball_counttxt.status == STARTED:
                    # update params
                    pass
                
                # *player2ball_counttxt* updates
                
                # if player2ball_counttxt is starting this frame...
                if player2ball_counttxt.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    player2ball_counttxt.frameNStart = frameN  # exact frame index
                    player2ball_counttxt.tStart = t  # local t and not account for scr refresh
                    player2ball_counttxt.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(player2ball_counttxt, 'tStartRefresh')  # time at next scr refresh
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'player2ball_counttxt.started')
                    # update status
                    player2ball_counttxt.status = STARTED
                    player2ball_counttxt.setAutoDraw(True)
                
                # if player2ball_counttxt is active this frame...
                if player2ball_counttxt.status == STARTED:
                    # update params
                    pass
                
                # *player3ball_counttxt* updates
                
                # if player3ball_counttxt is starting this frame...
                if player3ball_counttxt.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    player3ball_counttxt.frameNStart = frameN  # exact frame index
                    player3ball_counttxt.tStart = t  # local t and not account for scr refresh
                    player3ball_counttxt.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(player3ball_counttxt, 'tStartRefresh')  # time at next scr refresh
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'player3ball_counttxt.started')
                    # update status
                    player3ball_counttxt.status = STARTED
                    player3ball_counttxt.setAutoDraw(True)
                
                # if player3ball_counttxt is active this frame...
                if player3ball_counttxt.status == STARTED:
                    # update params
                    pass
            ...
            # store the players ball counts to the data files
            thisExp.addData('player_1_ball_count ', player_1_ball_count)
            thisExp.addData('player_2_ball_count ', player_2_ball_count)
            thisExp.addData('player_3_ball_count ', player_3_ball_count)
            ...
            ball_move = data.Routine(
                name='ball_move',
                components=[player3image_2, player1image_2, player2image_2, instructtxtbox_2, player1ball_counttxt_2, player2ball_counttxt_2, player3ball_counttxt_2, ballimage_2],
            )
            ...
            player1ball_counttxt_2.reset()
            player1ball_counttxt_2.setText('Balls received: ' + str(player_1_ball_count))
            player2ball_counttxt_2.reset()
            player2ball_counttxt_2.setText('Balls received: ' + str(player_2_ball_count))
            player3ball_counttxt_2.reset()
            player3ball_counttxt_2.setText('Balls received: ' + str(player_3_ball_count))
            ...
            while continueRoutine and routineTimer.getTime() < 3.0:
                ...
                # if player1ball_counttxt_2 is starting this frame...
                if player1ball_counttxt_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    player1ball_counttxt_2.frameNStart = frameN  # exact frame index
                    player1ball_counttxt_2.tStart = t  # local t and not account for scr refresh
                    player1ball_counttxt_2.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(player1ball_counttxt_2, 'tStartRefresh')  # time at next scr refresh
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'player1ball_counttxt_2.started')
                    # update status
                    player1ball_counttxt_2.status = STARTED
                    player1ball_counttxt_2.setAutoDraw(True)
                
                # if player1ball_counttxt_2 is active this frame...
                if player1ball_counttxt_2.status == STARTED:
                    # update params
                    pass
                
                # if player1ball_counttxt_2 is stopping this frame...
                if player1ball_counttxt_2.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > player1ball_counttxt_2.tStartRefresh + 3-frameTolerance:
                        # keep track of stop time/frame for later
                        player1ball_counttxt_2.tStop = t  # not accounting for scr refresh
                        player1ball_counttxt_2.tStopRefresh = tThisFlipGlobal  # on global time
                        player1ball_counttxt_2.frameNStop = frameN  # exact frame index
                        # add timestamp to datafile
                        thisExp.timestampOnFlip(win, 'player1ball_counttxt_2.stopped')
                        # update status
                        player1ball_counttxt_2.status = FINISHED
                        player1ball_counttxt_2.setAutoDraw(False)
                
                # *player2ball_counttxt_2* updates
                
                # if player2ball_counttxt_2 is starting this frame...
                if player2ball_counttxt_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    player2ball_counttxt_2.frameNStart = frameN  # exact frame index
                    player2ball_counttxt_2.tStart = t  # local t and not account for scr refresh
                    player2ball_counttxt_2.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(player2ball_counttxt_2, 'tStartRefresh')  # time at next scr refresh
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'player2ball_counttxt_2.started')
                    # update status
                    player2ball_counttxt_2.status = STARTED
                    player2ball_counttxt_2.setAutoDraw(True)
                
                # if player2ball_counttxt_2 is active this frame...
                if player2ball_counttxt_2.status == STARTED:
                    # update params
                    pass
                
                # if player2ball_counttxt_2 is stopping this frame...
                if player2ball_counttxt_2.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > player2ball_counttxt_2.tStartRefresh + 3-frameTolerance:
                        # keep track of stop time/frame for later
                        player2ball_counttxt_2.tStop = t  # not accounting for scr refresh
                        player2ball_counttxt_2.tStopRefresh = tThisFlipGlobal  # on global time
                        player2ball_counttxt_2.frameNStop = frameN  # exact frame index
                        # add timestamp to datafile
                        thisExp.timestampOnFlip(win, 'player2ball_counttxt_2.stopped')
                        # update status
                        player2ball_counttxt_2.status = FINISHED
                        player2ball_counttxt_2.setAutoDraw(False)
                
                # *player3ball_counttxt_2* updates
                
                # if player3ball_counttxt_2 is starting this frame...
                if player3ball_counttxt_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    player3ball_counttxt_2.frameNStart = frameN  # exact frame index
                    player3ball_counttxt_2.tStart = t  # local t and not account for scr refresh
                    player3ball_counttxt_2.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(player3ball_counttxt_2, 'tStartRefresh')  # time at next scr refresh
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'player3ball_counttxt_2.started')
                    # update status
                    player3ball_counttxt_2.status = STARTED
                    player3ball_counttxt_2.setAutoDraw(True)
                
                # if player3ball_counttxt_2 is active this frame...
                if player3ball_counttxt_2.status == STARTED:
                    # update params
                    pass
                
                # if player3ball_counttxt_2 is stopping this frame...
                if player3ball_counttxt_2.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > player3ball_counttxt_2.tStartRefresh + 3-frameTolerance:
                        # keep track of stop time/frame for later
                        player3ball_counttxt_2.tStop = t  # not accounting for scr refresh
                        player3ball_counttxt_2.tStopRefresh = tThisFlipGlobal  # on global time
                        player3ball_counttxt_2.frameNStop = frameN  # exact frame index
                        # add timestamp to datafile
                        thisExp.timestampOnFlip(win, 'player3ball_counttxt_2.stopped')
                        # update status
                        player3ball_counttxt_2.status = FINISHED
    ...
    goodbye = data.Routine(
        name='goodbye',
        components=[instructtxt_3, start_button_3],
    )
    ...
    while continueRoutine:
        ...
        # if instructtxt_3 is starting this frame...
        if instructtxt_3.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            instructtxt_3.frameNStart = frameN  # exact frame index
            instructtxt_3.tStart = t  # local t and not account for scr refresh
            instructtxt_3.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(instructtxt_3, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'instructtxt_3.started')
            # update status
            instructtxt_3.status = STARTED
            instructtxt_3.setAutoDraw(True)
        
        # if instructtxt_3 is active this frame...
        if instructtxt_3.status == STARTED:
            # update params
            pass
        # *start_button_3* updates
        
        # if start_button_3 is starting this frame...
        if start_button_3.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
            # keep track of start time/frame for later
            start_button_3.frameNStart = frameN  # exact frame index
            start_button_3.tStart = t  # local t and not account for scr refresh
            start_button_3.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(start_button_3, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'start_button_3.started')
            # update status
            start_button_3.status = STARTED
            win.callOnFlip(start_button_3.buttonClock.reset)
            start_button_3.setAutoDraw(True)
        
        # if start_button_3 is active this frame...
        if start_button_3.status == STARTED:
            # update params
            pass
            # check whether start_button_3 has been pressed
            if start_button_3.isClicked:
                if not start_button_3.wasClicked:
                    # if this is a new click, store time of first click and clicked until
                    start_button_3.timesOn.append(start_button_3.buttonClock.getTime())
                    start_button_3.timesOff.append(start_button_3.buttonClock.getTime())
                elif len(start_button_3.timesOff):
                    # if click is continuing from last frame, update time of clicked until
                    start_button_3.timesOff[-1] = start_button_3.buttonClock.getTime()
                if not start_button_3.wasClicked:
                    # end routine when start_button_3 is clicked
                    continueRoutine = False
                if not start_button_3.wasClicked:
                    # run callback code when start_button_3 is clicked
                    pass
        # take note of whether start_button_3 was clicked, so that next frame we know if clicks are new
        start_button_3.wasClicked = start_button_3.isClicked and start_button_3.status == STARTED
    ...
    thisExp.addData('start_button_3.numClicks', start_button_3.numClicks)
    if start_button_3.numClicks:
       thisExp.addData('start_button_3.timesOn', start_button_3.timesOn)
       thisExp.addData('start_button_3.timesOff', start_button_3.timesOff)
    else:
       thisExp.addData('start_button_3.timesOn', "")
       thisExp.addData('start_button_3.timesOff', "")
    thisExp.nextEntry()
